...
ALLOWED_HOSTS = [
    'www.Rimir.pythonanywhere.com',
    'Rimir.pythonanywhere.com',
    'localhost',
    '127.0.0.1',
    '[::1]',
    'testserver',
...
# LOGOUT_REDIRECT_URL = 'posts:index' — и при выходе из аккаунта пользователи
# будут перенаправляться на главную страницу проекта.
